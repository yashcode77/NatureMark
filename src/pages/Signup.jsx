...
const Signup = () => {
  return (
    <div className='flex h-screen justify-center items-center bg-neutral-100'>
      <div className='bg-white flex flex-row-reverse border-2 h-3/5 w-1/2 rounded-2xl shadow-2xl'>
        ...
        <div className='w-1/2 bg-gradient-to-br from-green-900 to-green-400 text-white flex-col gap-4 justify-center items-center rounded-tl-2xl rounded-bl-2xl content-center'>
          <div className='h-3/4 rounded-2xl flex flex-col gap-6 p-7 justify-center'>
            ...
            <div className='flex-col justify-center text-center'>Already have an account?</div>
